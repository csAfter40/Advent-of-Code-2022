...
class Monkey:
    ...
    total_divisible: ClassVar[int] = 1
    id: int
    items: List[int]
    operation: Tuple
    divisible:int
    ...
    def __post_init__(self) -> None:
        ...
        Monkey.obj_count += 1
        Monkey.total_divisible *= self.divisible
    ...
    def throw_to_target(self, level:int, target_id:int) -> None:
        ...
        level = level % self.total_divisible
    ...
    def run_round(self) -> None:
        ...
        for item in self.items:
            ...
            if operation_level % self.divisible == 0:
                self.throw_to_target(operation_level, self.true_target)
            else:
                self.throw_to_target(operation_level, self.false_target)
